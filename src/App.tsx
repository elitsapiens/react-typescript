    ...
    return (
        <BrowserRouter basename={process.env.PUBLIC_URL}>
            <div>
                ...
                <Link to="/user-info-reducer-custom-hook">
                    User Info Reducer Custom Hook
                </Link>
            ...
            <div>
                <Routes>
                    ...
                    <Route
                        path="/user-info-hooks"
                        element={<UserInfoHooks />}
                    />
                    <Route
                        path="/user-info-reducer"
                        element={<UserInfoReducer />}
                    />
                    <Route
                        path="/user-info-context"
                        element={<UserInfoContext />}
                    />
                    <Route
                        path="/user-info-reducer-custom-hook"
                        element={<UseInfoReducerCustomHook />}
                    />
                    /
                    <Route
                        path="/counter-reduce"
